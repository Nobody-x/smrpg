...
CREATE TABLE smrpg_player_upgrades (
	...
	FOREIGN KEY (player_id) REFERENCES smrpg_players(player_id) ON DELETE CASCADE,
	FOREIGN KEY (upgrade_id) REFERENCES smrpg_upgrades(upgrade_id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
